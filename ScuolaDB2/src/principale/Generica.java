...
public class Generica {
	...
	public void menu1(){
		System.out.println("1-Inserimento Studenti in assenza di foreign keys");
		System.out.println("2-Inserisci Studente+Indirizzo");
		System.out.println("3-Elimina Studente");
		System.out.println("4------");
		System.out.println("5-Lista Studenti e Indirizzi");
		System.out.println("6-Lista Studenti ResultSet");
		System.out.println("7-Lista Studenti ArrayList");
